...
import ru.itpark.dao.SavingsAccountDao;
import ru.itpark.dao.SavingsTransactionDao;
...
public class AccountServiceImpl implements AccountService {
    ...
    public void deposit(String accountType, double amount, Principal principal) {
        ...
        if (accountType.equalsIgnoreCase("Основной")) {
            ...
            SavingsTransaction savingsTransaction = new SavingsTransaction(date, "Пополнение сберегательного счета", "Счет", "Завершен", amount, savingsAccount.getAccountBalance(), savingsAccount);
    ...
    public void withdraw(String accountType, double amount, Principal principal) {
        ...
        if (accountType.equalsIgnoreCase("Основной")) {
            ...
            SavingsTransaction savingsTransaction = new SavingsTransaction(date, "Списание со сберегательного счета", "Счет", "Завершен", amount, savingsAccount.getAccountBalance(), savingsAccount);
